...
const ModuleBView = {
      ...
      <div class="acc-card" onclick="Router.navigate('/accommodation/${acc.id}')">
        ...
        <div class="acc-card-body">
          ...
          <div class="acc-card-meta">
            ...
            <span>距車站 ${acc.distanceFromStation}km</span>
          ...
          <div class="flex-center justify-between">
            ...
            <button class="btn btn-sm btn-outline" onclick="event.stopPropagation();ModuleBView.toggleFav('${acc.id}',this)">
              ${favoriteRepo.findOne(Store.getUser()?.id, acc.id) ? '已收藏' : '收藏'}
            </button>
          </div>
        </div>
      </div>
  ...
  toggleFav(accId, btn) {
    ...
    btn.innerHTML = result.isFavorited ? '已收藏' : '收藏';
      ...
      <div class="card">
        ...
        <div class="flex-center justify-between mb-8">
          ...
          <div class="flex gap-8">
            <button class="btn btn-outline" onclick="ModuleBView.toggleFav('${accId}',this)">${isFav ? '已收藏' : '收藏'}</button>
          </div>
        </div>
  ...
  showBookingModal(roomTypeId, accId) {
    ...
    UI.showModal(`
      <div class="modal-header"><h3>預訂 ${roomType?.name}</h3><button class="close-btn" onclick="UI.closeModal()">X</button></div>
  ...
  showReviewModal(bookingId) {
    UI.showModal(`
      <div class="modal-header"><h3>撰寫評價</h3><button class="close-btn" onclick="UI.closeModal()">X</button></div>
      <div class="modal-body">
  ...
  showCreateAccModal() {
    UI.showModal(`
      <div class="modal-header"><h3>新增房源</h3><button class="close-btn" onclick="UI.closeModal()">X</button></div>
      <div class="modal-body">
  ...
  showAddRoomTypeModal(accId) {
    UI.showModal(`
      <div class="modal-header"><h3>新增房型</h3><button class="close-btn" onclick="UI.closeModal()">X</button></div>
      <div class="modal-body">
  ...
  showSetPricingModal(roomTypeId, accId) {
    ...
    UI.showModal(`
      <div class="modal-header"><h3>設定定價</h3><button class="close-btn" onclick="UI.closeModal()">X</button></div>
      <div class="modal-body">
        <div class="form-row">
